...
namespace Wpf_Kasse_App.ViewModel
{
    class NavigationVM : ViewModelBase
    {
        ...
        public ICommand SalllOfPointCommand { get; set; }
        ...
        private void SalllOfPoint(object obj) => CurrentView = new SalllOfPointVM();
        ...
        public NavigationVM()
        {
            ...
            SalllOfPointCommand = new RelayCommand(SalllOfPoint);
